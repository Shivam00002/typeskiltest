...
const QSections: React.FC = () => {
  return (
    <>
      <div className="w-full grid h-28 grid-cols-1 md:grid-cols-4 gap-x-3 py-6 px-4 ">
        <div className="col-span-3 p-2   ">
          <div className='mt-[29px] flex gap-5 px-2 py-2 items-center fixed bg-white w-full h-auto'>
            <h2 className='font-bold'>Sections :</h2>
            <button className='py-2 px-3 rounded-full border-blue-600 text-blue-600'>Quiz</button>
          </div>
          ...
          <div>
            ...
            <div className='border w-full py-2 sticky bottom-0 bg-white h-fit'>
              <button
                className="px-2  mb-0 py-2 w-[110px] h-9  grid place-content-center mx-auto  content-center  border rounded  text-black border-black bg-white"
              >
                Back to Test
              </button>
            </div>
